...
ActiveRecord::Schema.define(version: 2022_10_10_184043) do
  ...
  create_table "maquilas", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "phone_num", limit: 255, null: false
  ...
  create_table "posts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "posteable_type", limit: 255, null: false
  ...
  create_table "suppliers", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "year_start", limit: 255, null: false
    t.string "phone_num", limit: 255, null: false
    t.string "address", limit: 255, null: false
    t.string "zip_code", limit: 255, null: false
